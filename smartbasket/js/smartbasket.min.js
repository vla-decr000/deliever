    ...
    t = jQuery, a = {
        ...
        showProducts: function(s) {
            let r = t("<form>").attr({
                ...
                }).html("Price for 1 item").append(p),
                u = t("<div>").attr({
                    class: "smart-basket__product-price"
                }).html(`Price / ${a.smartBasketCurrency}`).append(c).append(d);
            c.click(() => {
                d.fadeToggle()
            }), p.click(t => {
            ...
            let m = t("<div>").attr({
                ...
                }).html(`Total price / ${a.smartBasketCurrency}`),
                k = t("<div>").attr({
                    class: "smart-basket__product-delete"
                }).text("Remove");
        ...
        stateBasket: function() {
            ...
            return e.getSmartBasketMinState(o), c.click(function() {
                ...
                if (void 0 !== r[n]) {
                    let a = t(this).html();
                    return t(this).text("Product already added to  cart "), t("body").append(e.alertBlock("alreadyAdded")), setTimeout(() => {
                        t(this).html(a)
                    }, 1500), !1
                } {
                    let i = {};
        ...
        commonResult: function(e, s, r) {
            let n = 0,
                ...
                }).text("Cart is empty . You haven`t added any products ...").fadeOut(),
                l = t("<div>").attr({
                    class: "smart-basket__success-title"
                }).text("Order is accepted. Expect a call").css("display", "none"),
                c = t("<div>").attr({
            ...
            if (0 == +n ? o.fadeIn() : o.fadeOut(), r) t("." + l.attr("class")).css("display", "block"), setTimeout(() => {
                ...
                if (!s) return d.html(`<span>Total products:</span> ${n}`), p.html(`<span>Final price: </span> <input name="finalPrice" class="smart-basket__total-cost" type="text" value="${i.toFixed(2)} ${a.smartBasketCurrency}">`), c.append(o).append(l).append(d).append(p), c;
                0 == +n && t("." + o.attr("class")).css("display", "block"), t("." + d.attr("class")).html("<span>Total products: </span> "), t("." + d.attr("class")).html(`<span>Total products: </span> ${n}`), t("." + p.attr("class")).html("<span>Total cost: </span> "), t("." + p.attr("class")).html(`<span>Total cost: </span> <input name="finalPrice" class="smart-basket__total-cost" type="text" value="${i.toFixed(2)} ${a.smartBasketCurrency}">`)
            }
        },
        ...
        userForm: function() {
            ...
            if (c.append(p), a.agreement.isRequired) {
                ...
                r = a.agreement.isLink ? t("<a>").attr({
                    ...
                    class: "smart-basket__link-agreement"
                }), s.is(":checked") ? r.text("Введите свой город") : r.text(""), e.click(function() {
                    s.is(":checked") ? (r.text(""), s.val(""), m.attr({
                        disabled: "disabled"
                    }), d.addClass("smart-basket__input-wrapper_error")) : (r.text(""), s.val(""), m.attr({
                        disabled: !1
